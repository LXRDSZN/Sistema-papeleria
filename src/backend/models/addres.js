...
export const registerAddress3 = async (curp, calle, numero_exterior, numero_interior, colonia, ciudad, estado, pais, codigo_postal) => {
  ...
  try {
    ...
    const res = await client.query(query, [curp, calle, numero_exterior, numero_interior, colonia, ciudad, estado, pais, codigo_postal]);
