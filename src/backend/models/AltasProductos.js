...
export const resgistrerproducto = async (Codigo_barras, selectedCategory, Nombre_producto, Cantidad_producto, Precio_compra, precio_venta) => {
  ...
  const query = `
    ...
    (Codigo_barras, selectedCategory, Nombre_producto, Cantidad_producto, Precio_compra, precio_venta)
    VALUES ($1, $2, $3, $4, $5, $6)
    RETURNING *;
  `;
  ...
  try {
    ...
    const res = await client.query(query, [Codigo_barras, selectedCategory, Nombre_producto, Cantidad_producto, Precio_compra, precio_venta]);
